...
import { Alert, Text, View, SafeAreaView, StyleSheet, Platform, StatusBar, FlatList, Image, ImageBackground, Dimensions } from 'react-native';
...
export default class MeteorScreen extends Component {
    ...
    getMeteors = () => {
        axios.get("https://api.nasa.gov/neo/rest/v1/feed?api_key=sbNDMqVgRaWxUjeKWQvGTAr6IuNNmd1OojcGrGzo")
            .then(response => {
                this.setState({
